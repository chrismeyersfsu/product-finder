    ...
    "extractors": {
        ...
        "is_parts": {
            "pattern": (
                ...
                r"|charger adapter|\bsleeve\b|privacy filter|screen protector|^.{0,45}\b(?:charger|adapter|power supply|psu|battery|case|sleeve|bag|skin|stand|dock|hub|cover|mount|cable)\b"
